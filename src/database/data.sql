INSERT INTO luminadb.roles VALUES(1,"customer"), (2,"admin"), (3,"gestor");
/* Adding two users admin and cutomer */
INSERT INTO luminadb.users values(1,"Ignacio Agustín", "Padilla", "2000-08-22", "nacho20002008@hotmail.com", "+54 1130673225", "1710027734943_img_.png","$2a$12$n4C9cbFtaTuFMHRSgbKoK.RccAK/a2DzL8.i7PNHMVaRGhQmEfE72", 2),
...
/*Adding colors*/
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('brown');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('black');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('white');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('red');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('grey');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('royal blue');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('core black');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('core white');
INSERT INTO `luminadb`.`colors` (`color_name`) VALUES ('navy black');

/*Adding discounts*/
INSERT INTO `luminadb`.`discounts` (`percent`) VALUES ('50');
INSERT INTO `luminadb`.`discounts` (`percent`) VALUES ('30');

/*Adding categories*/
INSERT INTO `luminadb`.`categories` (`category_name`) VALUES ('clothes');
INSERT INTO `luminadb`.`categories` (`category_name`) VALUES ('accesory');
INSERT INTO `luminadb`.`categories` (`category_name`) VALUES ('footwear');

/*Adding products*/
INSERT INTO `luminadb`.`products` (`product_name`, `price`, `overview`, `care_instructions`, `composition`, `stock`, `category_id`, `discount_id`) VALUES ('Zapatillas Grand Court Alpha', '59.5', 'Las 3 Tiras evocan el legado de Lumina. Y cuando se las combina con estas zapatillas adidas Grand Court Alpha, celebran generaciones de originalidad. La silueta minimalista crea ese look atemporal. El logo en relieve en la lengüeta y las elegantes costuras le dan un toque moderno. La amortiguación Cloudfoam le inyecta comodidad a cada uno de tus pasos.', 'Lavar a máquina del revés, temperatura max. 30°', '98% Algodón 2% Spandex', '300', '3', '1');
...
INSERT INTO `luminadb`.`products` (`product_name`, `price`, `overview`, `care_instructions`, `composition`, `stock`, `category_id`) VALUES ('Bolso para botines Tiro League', '35.999', 'Creado para el deporte rey. Este bolso para botines adidas forma parte de la colección Tiro League y mantiene tus botines sanos y salvos mientras no los tenés puestos. Su exterior tejido resistente lo hace perfecto para resistir los golpes y raspones del vestuario. El panel de ventilación de malla se encarga de que tus botines se empiecen a secar de manera natural mucho antes de llegar a casa. Este producto, hecho con una serie de materiales reciclados y al menos un 40 % de contenido reciclado, representa solo una de nuestras soluciones para acabar con los residuos plásticos.', 'Limpiar únicamente con paño húmedo. No usar blanqueador, secadora ni lavar en seco.', '98% Algodón 2% Spandex', '100', '2');
...
insert INTO luminadb.product_color values(2, 1),(3, 1),(4, 2), (5, 2),(8, 3),(6, 3),(3, 4), (3, 5),(3, 6),(3, 7),(3, 8);


/*Asoseate image with products*/
INSERT INTO luminadb.product_images VALUES("grand-court-alpha-1.jpg", 1),("grand-court-alpha-2.jpg", 1),("grand-court-alpha-3.jpg", 1),("grand-court-alpha-4.jpg", 1);
INSERT INTO luminadb.product_images VALUES("cap-running-adizero-1.jpg", 2),("cap-running-adizero-2.jpg", 2),("cap-running-adizero-3.jpg", 2);
INSERT INTO luminadb.product_images VALUES("boot-bag-tiro-league-1.jpg", 3),("boot-bag-tiro-league-2.jpg", 3),("boot-bag-tiro-league-3.jpg", 3),("boot-bag-tiro-league-4.jpg", 3);
INSERT INTO luminadb.product_images VALUES("ball-argentum-22-league-1.jpg", 4),("boot-bag-tiro-league-2.jpg", 4),("boot-bag-tiro-league-3.jpg", 4),("boot-bag-tiro-league-4.jpg", 4);
INSERT INTO luminadb.product_images VALUES("branded-layer-1.jpg", 5),("branded-layer-2.jpg", 5);
INSERT INTO luminadb.product_images VALUES("yoga-trainning-tshirt-1.jpg", 6),("yoga-trainning-tshirt-2.jpg", 6), ("yoga-trainning-tshirt-3.jpg", 6), ("yoga-trainning-tshirt-4.jpg", 6);
INSERT INTO luminadb.product_images VALUES("booties-crazyfast-1.jpg", 7),("booties-crazyfast-2.jpg", 7), ("booties-crazyfast-3.jpg", 7), ("booties-crazyfast-4.jpg", 7);
INSERT INTO luminadb.product_images VALUES("sneakers-cross-emup-1.jpg", 8),("sneakers-cross-emup-2.jpg", 8), ("sneakers-cross-emup-3.jpg", 8), ("sneakers-cross-emup-4.jpg", 8);